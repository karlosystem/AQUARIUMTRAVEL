...
<p>
	...
	<?php print tep_draw_input_field('name_paquete[' . $languages[$i]['id'] . ']',$data_title[0]['title'],'class="input-long"',TRUE); ?> 
...
<p>
    ...
    <input name="txt_datepublicacion" type="text" class="input-short" id="txt_datepublicacion"  value="<?php
 ...
 <p>
	<label>Viaje desde:</label>
     ...
     <input name="txt_desde" type="text" class="input-short" id="txt_desde"  value="<?php
...
<p>
	<label>Hasta:</label>
    <input name="txt_hasta" type="text" class="input-short" id="txt_hasta"  value="<?php
 ...
 <p>
	...
	<input name="txt_dias" type="text" class="input-short" id="txt_dias" value="<?php print $cls_paquete->getint_countdias();?>"/>
	<span class="notification-input ni-correct"></span>
</p>

 <p>
	<label>Cantidad de Noches:</label>
	<input name="txt_noches" type="text" class="input-short" id="txt_noches" value="<?php print $cls_paquete->getint_countnoches();?>" />
	<span class="notification-input ni-correct"></span>
</p>
...
?>	
 <p>
	...
	<?php print tep_draw_input_field('traslado_paquete[' . $languages[$i]['id'] . ']',$data_traslado[0]['traslate'],'class="input-medium"',FALSE); ?> 
	<span class="notification-input ni-correct"></span>
</p>
<?php
  }
...
?>
 <p>
	...
	<?php print tep_draw_input_field('boleto_paquete[' . $languages[$i]['id'] . ']',$data_boleto[0]['boleto'],'class="input-medium"',FALSE); 
	  ?>
	<span class="notification-input ni-correct"></span>
</p>
<?php
...
<p>
	...
	<select name="sle_aeropuerto" class="input-short" id="sle_aeropuerto" title="Seleccione el aeropuerto">
		<option value="0"> Seleccione el Aeropuerto:</option>
 ...
 <p>
	...
	<input name="txt_precio" onkeyup="return printFloat();filterNonNumeric(this);" type="text" class="input-short" id="txt_precio" value="<?php print $cls_paquete->gettxt_precio();?>" />
	<span class="notification-input ni-correct"></span>
</p>	

 <p>
	<label>Tipo de Cambio: </label>
	<input name="txt_tipo_cambio" type="text" class="input-short" id="txt_tipo_cambio" value="<?php echo ToMoney(_TIPOCAMBIO_DOL, false)?>" />
	<span class="notification-input ni-correct"></span>
</p>	
 ...
 <p>
	...
	<input name="txt_precio_soles" onkeyup="return filterNonNumeric(this);" type="text" class="input-short" id="txt_precio_soles" value="<?php print $cls_paquete->gettxt_precio_soles();?>" />
	<span class="notification-input ni-correct"></span>
</p>		
...
<fieldset>
	...
	<ul>
		<li>
		<label><input type="checkbox" name="chk_destacado" id="chk_destacado"  value="1" <?php print ($cls_paquete->gettxt_isdestacado()==1)?'checked':'';?>/> Paquete Destacado en Portada</label></li>
		
		<li>
		<label><input type="checkbox" name="chk_nuevo" id="chk_nuevo"  value="1" <?php print ($cls_paquete->gettxt_isnuevo()==1)?'checked':'';?>/>  Paquete Nuevo en Pie</label></li>
...
?>
 <p>
	...
	<?php echo tep_image(DIR_WS_ADS_LANGUAGES . $languages[$i]['directory'] . '/images/' . $languages[$i]['image'], $languages[$i]['name']); ?>
	<?php print tep_draw_input_field('meta_title_paquete[' . $languages[$i]['id'] . ']',$data_meta_title[0]['meta_title'],'id="testmeta" class="input-long"',TRUE); ?>
</p>
<?php
  }
?>
...
jQuery(function($){
$("#txt_datepublicacion").mask("99/99/9999",{placeholder:"0"});
$("#txt_desde").mask("99/99/9999",{placeholder:"0"});
$("#txt_hasta").mask("99/99/9999",{placeholder:"0"});
});

new Zapatec.Calendar.setup({inputField:"txt_datepublicacion",ifFormat:"%d/%m/%Y",button:"cal_detapublicacion",showsTime:false});
new Zapatec.Calendar.setup({inputField:"txt_desde",ifFormat:"%d/%m/%Y",button:"cal_desde",showsTime:false});
new Zapatec.Calendar.setup({inputField:"txt_hasta",ifFormat:"%d/%m/%Y",button:"cal_hasta",showsTime:false});
</script>
