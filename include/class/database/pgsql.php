...
if (!function_exists('pg_connect')) {
	die("Su instalación de PHP no tiene soporte para PostgreSQL. Por favor, activa el soporte para PostgreSQL en PHP o consulte a su proveedor de alojamiento web.");
}
