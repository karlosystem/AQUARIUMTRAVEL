...
function count_entries($table, $field = "", $field_equal = "", $arr_where = "")
{ // Usage 1 = table name 2 = field to search 3 = what to match
...
function removeEvilTags($source)
{
	...
	return preg_replace_callback($reg, "removeEvilAttributes", $source);
}
...
function tep_href_link($page = '', $parameters = '', $add_session_id = false)
{
	...
	if (!tep_not_null($page)) {
		die('<br><br><font color="#ff0000"><b>Error!</b></font><br><br><b>No se puede determinar el v�nculo de la p�gina!<br><br>');
	}
