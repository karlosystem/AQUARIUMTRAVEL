...
$meta_title = $PaqueteDetails[0]['meta_title'];
...
#Actualizar el numero de visitas + 1
#$sql = $GLOBALS['CONNECT_DB']->Query("update tbl_paquete set int_visto = int_visto + 1 where pk_paquete = " + $Cid);
#$GLOBALS['CONNECT_DB']->Fetch($sql);
